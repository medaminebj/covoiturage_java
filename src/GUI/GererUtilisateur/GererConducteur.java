 ...
 * @author sabri
 */
public class GererConducteur extends javax.swing.JFrame {

    /**
     * Creates new form GerrerConducteur
     */
    public GererConducteur() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        datagrid.setModel(new utils.components.jtable.tableModelGererUtilisateur());
 ...
 private void changerEtatInformation(boolean etat){
    ...
    private void remplireInformations(int ligne){
        Authentification authentification = ((utils.components.jtable.tableModelGererUtilisateur)datagrid.getModel()).getRowEntity(ligne);
        Conducteurs conducteur = (Conducteurs)authentification.getCompte();
        
        nomTF.setText(conducteur.getNom());
        prenomTF.setText(conducteur.getPrenom());
        dateNaissanceTF.setText(conducteur.getDateNaissance().toString());
    ...
    private void supprimerBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimerBtnMouseClicked
        ...
        metier.AuthentificationMetier authentificationMetier = new  metier.AuthentificationMetier();
         try {
            Authentification authentification = ((utils.components.jtable.tableModelGererUtilisateur)datagrid.getModel()).getRowEntity(datagrid.getSelectedRow());
            Conducteurs conducteur = (Conducteurs)authentification.getCompte();
            ...
            {
                if (DAO.ConducteursDAO.getInstance().delete(conducteur))
                {
    ...
    private void enregisterBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enregisterBtnMouseClicked
     ...
     Conducteurs conducteur= new Conducteurs();
        ...
        //modification
                ...
                Conducteurs conduc = (Conducteurs)((utils.components.jtable.tableModelGererUtilisateur)datagrid.getModel()).getRowEntity(datagrid.getSelectedRow()).getCompte();
                conducteur.setIdConducteurs(conduc.getIdConducteurs());
                String jjj = nomTF.getText();
                conducteur.setNom(jjj);
                ...
                if (sexeCB.getSelectedIndex() == 1)
                    conducteur.setSexe('H');
                else
                    conducteur.setSexe('F');

                authentification.setCompte(conducteur);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GererConducteur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GererConducteur().setVisible(true);
            }
        });
    }
